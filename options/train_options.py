...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_HPE', type=float, default=700.0, help='weight of HPE loss')
        self.parser.add_argument('--lambda_idt', type=float, default=1.0, help='weight of idt loss')
        self.parser.add_argument('--lambda_cycle', type=float, default=0.5, help='weight of cycle loss')
